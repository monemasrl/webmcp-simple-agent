...
const EN: Catalog = {
  ...
  'phase.waiting': 'Receiving response…',
  'phase.tools': 'Calling tool {name}…',
  'phase.toolsDone': 'Tool responded',
  'phase.reprocessing': 'Processing response…',
  'phase.done': 'Processed in {s}s',
...
const IT: Catalog = {
  ...
  'phase.sending': 'Invio richiesta…',
  'phase.waiting': 'Ricezione risposta…',
  'phase.tools': 'Chiamata tool {name}…',
  'phase.toolsDone': 'Strumento ha risposto',
  'phase.reprocessing': 'Elaborazione risposta…',
  'phase.done': 'Elaborato in {s}s',
